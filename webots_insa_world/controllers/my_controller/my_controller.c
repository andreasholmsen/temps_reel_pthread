...
void get_orders(void) {
    ...
    if (n < 0) {
      ...
      while (strToken != NULL) {
       if (strToken[0] == 'M') { /* set the speed of the motors */
          int new_left_speed, new_right_speed;
          sscanf(strToken, "M,%d,%d", &new_left_speed, &new_right_speed);
        ...
        else if (strToken[0] == 'S') { /* Read distance sensors */
        ...
        else if (strToken[0] == 'W') { /* Read wheel sensors odo */
        ...
        else if (strToken[0] == 'B') { /* Read battery level */
        ...
        else if (strToken[0] == 'T') { /* Turn robot */
          sscanf(strToken, "T,%lf", &target_ang_position);
